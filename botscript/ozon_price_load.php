...
$body = json_encode([
    ...
    if ($status==200){                                  // тест статуса ответа API
         ...
         if (count($array)>0) {                         //если не пустой массив
            ...
            $query = "DELETE from prices  WHERE (cabinet='".$cabinet."' and dat = '".$dat."')";
            ...
            foreach ($product_list As $prod) {       
               ...
               $query = "INSERT INTO prices (cabinet, dat, sku, offer_id, title, barcode, old_price, min_price, marketing_price, price, marketing_seller_price)  VALUES ('".$cabinet."', '".$dat."', '".$id."', '".$offer_id."', '".$title."', '".$barcode."', '".$old_price."', '".$min_price."', '".$marketing_price."', '".$price."', '".$marketing_seller_price."')"; 
